        ...
        var I = !1,
            ...
            w = {
                config: function (e) {
                    ...
                    O(function () {
                        if (t)
                            ...
                            y.state = 1;
                            for (
                                var e = S._completes, n = 0, i = e.length;
                                n < i;
                                ++n
                            )
                                e[n]();
                ...
                ready: function (e) {
                    0 != y.state
                        ? e()
                        : (S._completes.push(e), !l && v.debug && e());
                },
                error: function (e) {
                        ...
                        ((e._complete = function (e) {
                            e = (function (e) {
                                return (
                                    ...
                                    (e.countryName =
                                        e.addressCountiesThirdStageName),
                ...
                addCard: function (e) {
                    for (
                        var n = e.cardList, i = [], t = 0, o = n.length;
                        t < o;
                        ++t
                    ) {
                        var r = n[t],
