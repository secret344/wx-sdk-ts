...
/**
 *
 * 除 postMessage getEnv 外
 * 参数与小程序一致
 *
 * @interface MiniProgram
 */
interface MiniProgram {
  /** 获取当前环境*/getEnv: (fun: AnyFun) => void;
    navigateBack: (options: any) => void;
    navigateTo: (options: any) => void;
  /** 向小程序发送消息，会在特定时机（小程序后退、组件销毁、分享）触发组件的message事件*/postMessage: (options: any) => void;
...
export interface Sdk {
  ...
  /** 拍照或从手机相册中选图接口*/ chooseImage: (options: ChooseImage) => void;
  ...
  /** 使用微信内置地图查看位置接口*/ openLocation: (options: Location) => void;
  ...
  /** 拉取适用卡券列表并获取用户选择信息*/ chooseCard: (options: Card) => void;
  ...
  /** 关闭查找周边ibeacon设备接口*/ stopSearchBeacons: (options: Extra) => void;
